...
export default function Biomedicina() {
  ...
  const Biomedicina = [
    ...
    {
      titulo: 'Biomed 3: Soma de Elementos',
    ...
    {
      titulo: 'Biomed 4: Verificar Palíndromo',
    ...
    {
      titulo: 'Biomed 5: Números Primos',
    ...
    {
      titulo: 'Biomed 8: Encontrar Máximo',
    ...
    {
      titulo: 'Biomed 9: Inverter String',
    ...
    {
      titulo: 'Biomed 10: Remover Duplicatas',
  ...
  const BiomedicinaFiltrados = Biomedicina.filter(d => d.titulo.toLowerCase().includes(filtro.toLowerCase()));
        ...
        {!CursoBiomed ? (
          <>
            <h1 className="text-3xl font-bold flex items-center gap-2 mb-1">
              Biomedicina de Programação
            </h1>
            <p className="text-gray-300 mb-4">Explore e pratique conceitos fundamentais de JavaScript resolvendo Biomedicina interativos.</p>
            <input
              type="text"
          ...
          <div className="bg-white text-black p-6 rounded-xl shadow">
            ...
            <textarea
              ...
              placeholder={CursoBiomed.placeholder}
            />
